    ...
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="modal" data-target="#exampleModalCenter">Login</a>
          ...
          <!-- animated svg-->
<svg  id='homelady' width="638" height="500" viewBox="0 0 638 687" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path id="Vector_5" d="M242.147 183.841L239.549 167.797L236.868 184.004L229.053 184.247C234.403 164.825 234.696 145.92 229.582 127.661C225.852 114.344 229.244 99.6043 238.886 91.237C243.629 87.026 249.689 84.5957 256.027 84.3629L277.906 83.6847C290.81 83.2847 302.104 92.3097 306.765 105.327C308.523 110.493 309.17 115.972 308.665 121.406C307.019 141.527 307.808 161.774 311.014 181.706L242.147 183.841Z" fill="#2F2E41"/>
...
<path id="Vector_13" d="M268.968 155.754C251.91 155.754 238.081 141.926 238.081 124.868C238.081 107.81 251.91 93.9818 268.968 93.9818C286.025 93.9818 299.854 107.81 299.854 124.868C299.854 141.926 286.025 155.754 268.968 155.754Z" fill="#9F616A"/>
                 ...
                 <div class="masthead mx-auto ">
                    <div class="container d-flex h-100 align-items-center">
                      <div class="mx-auto text-center index_text">
                        ...
                        <h2 class=" mx-auto mt-2 mb-5 text-light-50">Home For All Financial Transactions</h2>
                      </div>
                    </div>
                </div>
